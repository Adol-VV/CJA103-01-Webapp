...
<body>
    ...
    <h3>新增訂單</h3>
    <label>會員ID：</label>
    <input type="text" name="memberId" value="${order.memberId}"><br>
    <label>主辦方ID：</label>
    <input type="text" name="organizerId" value="${order.organizerId}"><br>
    ...
    <label>訂單狀態：</label>
    <select name="status">
        <option value="0" ${empty order or order.status == 0 ? 'selected' : ''}>未付款</option>
